    ...
    "interFoam": [
        dict(name="interFoam_main", of_symbol="main",
             ...
             validation="A WHOLE TIME STEP'S ALPHA HALF NOW RUNS ON THE DEVICE "
                        ...
                        "divDevRhoReff's BOUNDARY sigma: the device builds gradB with OF's gaussGrad "
                        "correction (wall-normal component replaced by the patch snGrad) and multiplies "
                        "by nuBnd, and one of those two differs from what the host's addDivDevReff uses. "

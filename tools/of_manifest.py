    ...
    "interFoam": [
        ...
        dict(name="interFoam_kOmegaSST", of_symbol="kOmegaSSTBase",
             ...
             validation="tests/interfoam_waterchannel_vs_openfoam.sh, real OpenFOAM on RAS/waterChannel AS SHIPPED "
                        ...
                        "closure, the stopping point nor the non-orthogonal correction. REFUSED BY NAME on the device "
                        "until it is ported; it is the only shipped interFoam tutorial with an inletOutlet on U.",

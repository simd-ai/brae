    ...
    "interFoam": [
        ...
        dict(name="interFoam_dynamicMesh", of_symbol="mesh.update",
             ...
             validation="tests/interfoam_moving_vs_openfoam.sh, real OpenFOAM run SERIALLY, ten fixed steps of 2e-4 on "
                        ...
                        "tube is 100% of U and 0.8 of alpha away. TWO THINGS ARE STAGED AWAY FROM THE TUTORIAL, each a "
                        "refusal or a substitution today and not a choice: div(rhoPhi,U) `Gauss vanLeerV` -> `Gauss "
                        "linear`, and p_rghFinal's PCG with a GAMG PRECONDITIONER -> `solver GAMG; smoother DIC;` at "
                        "its tolerance. BROKEN ONCE EACH: phi left absolute after the corrector alpha 9.2e-01 and U "

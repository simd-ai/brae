    ...
    "interFoam": [
        dict(name="interFoam_main", of_symbol="main",
             ...
             note="The time loop, and the sub-cycle inside it. THE SUB-CYCLE is used by 33 of the 44 "
                  ...
                  "reaching `End:`: damBreak and capillaryRise, the two that are gated. NOT CLAIMED: that "
                  "nOuterCorrectors 2, nNonOrthogonalCorrectors 1 and momentumPredictor yes are RIGHT on "
                  "the host -- they run, and nothing holds them against OpenFOAM yet; alphaApplyPrevCorr "
                  "ran ungated for as long and was carrying a wrong limiter argument."),

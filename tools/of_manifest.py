    ...
    "interFoam": [
        dict(name="interFoam_main", of_symbol="main",
             ...
             validation="A WHOLE TIME STEP'S ALPHA HALF NOW RUNS ON THE DEVICE "
                        ...
                        "term is ruled out too -- assembling both sides with nuEff ZEROED leaves the "
                        "source gap IDENTICAL and its scale unchanged, so the source is dominated by "
                        "the ddt (rDeltaT*rhoOld*V*UOld, about 0.2 on this mesh) and the dev2 term is "
                        "not the fault. UOld is the same array on both sides, V is the mesh's, and "
                        ...
                        "equation is now right to 1.1e-05 relative; the whole-step U gap barely moved "
                        "(1.5848e-01 -> 1.5332e-01), so what remains is DOWNSTREAM of the assembly. "
